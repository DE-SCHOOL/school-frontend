...
import { getCoursesBySearch } from '../../store/courses/courseSlice';

let TITLE = `ALL COURSES`;
let LEVEL = '';
function SearchCourses({ styles, type = '', form }) {
	...
	const handleSearch = (e) => {
		...
		dispatch(getCoursesBySearch(searchData));
	...
	return (
		<React.Fragment>
			...
			<br />
			{type === 'print' && (
				<h1 className="print-student-title title">{TITLE + LEVEL}</h1>
			)}
		</React.Fragment>
	);
}
