...
import TableSequenceStats from '../../../components/tables/TableSequenceStats';
import SchoolHeader from '../../../components/social/SchoolHeader';

function SequenceStatistics() {
	...
	// Fetch the current academic year on mount
	useEffect(() => {
		...
		<div className="stud-print">
			...
			<section className="students">
				<div className="main-table-container">
					<TableSequenceStats styles="no-position" specialty={specialty} />
				</div>
			</section>
