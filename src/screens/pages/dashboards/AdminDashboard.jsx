...
function AdminDashboard() {
	...
	const genState = useSelector((state) => state);
		...
		<Layout>
			<div className="dashboard-body">
				...
				<div className="school-overview">
					<Overview
						groupName="Students"
						number={`${genState.students.students?.length}+`}
						children={<FaGraduationCap className="overview-icon" />}
					/>
					<Overview
						groupName="Staffs"
						number={`${genState.staffs.teachers?.data?.length}+`}
						children={<FaAward className="overview-icon" />}
					/>

					<Overview
						groupName="Departments"
						number={`${genState.departments.departments?.data?.length}+`}
