...
import { TableAllResultDataSequence } from '../../../components/tables';
...
function StudentResultAllSequence() {
	...
	return (
		<div className="stud-print">
			...
			<section className="students">
				<TableAllResultDataSequence styles="no-position" />
			</section>
...
export default StudentResultAllSequence;
