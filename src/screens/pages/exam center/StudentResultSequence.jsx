...
import { TableResultsSequence } from './../../../components/tables';
...
function StudentResultSequence() {
	...
	return (
		<Layout>
			{student !== undefined && Object.entries(student).length !== 0 && (
				<StudentInfo student={student} isTerm={false} />
			)}
...
export default StudentResultSequence;
